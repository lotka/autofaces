\chapter{Deep Learning Background} \label{chapter:deep}
  ...
  \section{Model Components}
    \subsection{Artificial Neural Networks}
      ...
      then be thought of as a function with a nested structure (these are also known as fully connected layers):
      \begin{equation}
      ...
      \end{equation}
      this is called the mean squared error, another popular cost function is
      the cross entropy:
      \begin{equation}
      ...
      towards the local minimum. Another training algorithm which builds on this is called is Adam \cite{adam}. {\color{red} TODO: Expand this section}
