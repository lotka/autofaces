...
%   other methods might be better because they can do sequences.
  ...
  \begin{figure}
   ...
   represents potentially many layers of neurons and the thin lines represent connections between layers.
   This diagram serves as a very high level description of the structure this project will
   investigate, the boxes which signify neural network structures may be made up of
   a variety of components including convolutional layers, fully connected layers, dropout layers
   and so on.} \label{fig:idea}
  \end{figure}
  ...
  \section{Contributions}
    ...
    % - evaluation of different pre-processing methods, balance functions, network structures, etc. (provide a detailed list)
    % To the end!
