\chapter{Modelling DISFA} \label{sec:model}
  ...
  \section{Convolutional Networks}
    ...
    \subsection{Shared Weights}
      ...
      between the encoder and decoder sections. Using the experimentation framework we built
      checking whether this is worthwhile is easy and insightful to do in the same manner as in the preivous section.
    ...
    \subsection{Dropout}
      ...
      in weights and encourage simpler complex models, i.e. it should be easier for the classifier to try and learn
