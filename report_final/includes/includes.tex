...
\usepackage{multirow,multicol,caption,todonotes,arydshln}
...
\usepackage{array}
\usepackage{latexsym}
\usepackage[pdftex,pagebackref,hypertexnames=false,colorlinks,backref]{hyperref} % provide links in pdf
