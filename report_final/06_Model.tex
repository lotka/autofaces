\chapter{Modelling DISFA} \label{sec:model}
  ...
  \section{Convolutional Networks}
    ...
    \subsection{Local Contrast Normalisation}
      ...
      detrmental for the other networks. For this reason, it will not be included in the subsequent sections.
    ...
    \subsection{Dropout}
      ...
      \caption{12 experiments which investigate the affect on appyling dropout to the
    ...
    Figures \ref{fig:l2_1} and \ref{fig:l2_2} show how the method
    is effective in reducing overfitting on the training subjects.
    However it also shows that it reduces the perfomance of the classifier,
    hence requiring more training iterations while also protecting the autoencoder.
    \todo{expand}
