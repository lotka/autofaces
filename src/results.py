...
class Results(object):
    ...
    def cross(self):
        ...
        CUT = 0
        plt.plot(self.x_axis[CUT:], self.cent_axis[0, CUT:] / 2000.0, label='validation')
        plt.plot(self.x_axis[CUT:], self.cent_axis[1, CUT:]/100.0, label='train')
        plt.legend()
